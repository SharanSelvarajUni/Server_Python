...
bin_input_file_1 = f"../Testing/Experiment-2/ClientData_192.168.1.10.bin"
bin_input_file_2 = f"../Testing/Experiment-2/ClientData_192.168.1.20.bin"
bin_input_file_3 = f"../Testing/Experiment-2/ClientData_192.168.1.30.bin"
bin_input_file_4 = f"../Testing/Experiment-2/ClientData_192.168.1.40.bin"
hex_output_file_1 = f"../Testing/Experiment-2/output_hex_data_192.168.1.10.txt"
hex_output_file_2 = f"../Testing/Experiment-2/output_hex_data_192.168.1.20.txt"
hex_output_file_3 = f"../Testing/Experiment-2/output_hex_data_192.168.1.30.txt"
hex_output_file_4 = f"../Testing/Experiment-2/output_hex_data_192.168.1.40.txt"
# sync_output_file = f"../Testing/Experiment-1/{FREQUENCY}Khz/synchronization_analysis.txt"
sync_output_file = f"../Testing/Experiment-2/Analysis_Results"
