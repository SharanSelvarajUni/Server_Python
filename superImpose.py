...
# Define file path
file1 = f"../Testing/Experiment-1/{FREQUENCY}Khz/output_hex_data({FREQUENCY}Khz)_192.168.1.10.txt"  # Replace with actual filename
# file2 = f"../Testing/Experiment-1/{FREQUENCY}Khz/output_hex_data({FREQUENCY}Khz)_192.168.1.20.txt"  # Replace with actual filename
file3 = f"../Testing/Experiment-1/{FREQUENCY}Khz/output_hex_data({FREQUENCY}Khz)_192.168.1.30.txt"  # Replace with actual filename
# file4 = f"../Testing/Experiment-1/{FREQUENCY}Khz/output_hex_data({FREQUENCY}Khz)_192.168.1.40.txt"  # Replace with actual filename
...
voltage_values1 = (decimal_values1 / 32767) * 5  # Convert to voltage range
...
# voltage_values2 = (decimal_values2 / 32767) * 10  # Convert to voltage range
...
voltage_values3 = (decimal_values3 / 32767) * 5   # Convert to voltage range
...
# voltage_values4 = ((decimal_values4 / 32767) * 10)   # Convert to voltage range
...
plt.plot(time_values1, smoothed_values1, label='Board 1', linewidth=2, linestyle='-', color='orange')
# plt.plot(time_values2, voltage_values2, label='Board 2', linewidth=2, linestyle='--', color='red')
plt.plot(time_values3, smoothed_values3, label='Board 3', linewidth=2, linestyle='-.', color='green')
# plt.plot(time_values4, voltage_values4, label='Board 4', linewidth=2, linestyle=':', color='black')
